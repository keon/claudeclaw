import { getThreadIdFromError } from "../claude/claude-client";
import type { ClaudeRunRequest, ClaudeRunResult } from "../claude/claude-types";
...
type ClaudeClient = {
  runTurn: (request: ClaudeRunRequest) => Promise<ClaudeRunResult>;
};
...
export type RunAgentTurnResult = ClaudeRunResult & {
  logFile: string;
};
